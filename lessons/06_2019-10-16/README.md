...
Вычислите и напечатайте на экране число пи с точностью до 1000 знаков после запятой при помощи рекурсии и формулы Лейбница:

![Формула Лейбница](./leibnits.gif)
